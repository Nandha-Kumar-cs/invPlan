            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo anchor('reports/invoice_aging_inr', trans('invoice_aging_inr')); ?></li>
                        <li><?php echo anchor('reports/inv_report', trans('inv_report')); ?></li>
	        	...
	        	<li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-caret-down"></i> &nbsp;
                        <span class="hidden-md"><?php _trans('po'); ?></span>
                        <i class="visible-md-inline fa fa-bar-chart"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><?php echo anchor('po/add_po', trans('add_po')); ?></li>
                        <li><?php echo anchor('po/list_po', trans('list_po')); ?></li>
                        <!--<li><?php echo anchor('po/list_pending_po', 'List Pending PO'); ?></li>
						<li><?php echo anchor('po/add_ats', 'Add ATS'); ?></li>-->
                        <li><?php echo anchor('po/list_ats', 'List ATS'); ?></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-caret-down"></i> &nbsp;
                        <span class="hidden-md"><?php _trans('Duty Slip'); ?></span>
                        <i class="visible-md-inline fa fa-bar-chart"></i>
                    </a>
                    <ul class="dropdown-menu">
