...
<script>
    $(function () {
		...
		if($('#5').val()!='' && $('#invoice_terms').val()!='' && $('#51').val()!=''){ 
            var items = [];
            var item_order = 1;
		...
		$('#btn_generate_invoice').click(function () {
            window.open('<?php echo site_url('invoices/generate_invoice/' . $invoice_id); ?>', '_blank'); 
        });
    ...
    <div class="headerbar-item pull-right <?php if ($invoice->is_read_only != 1 || $invoice->invoice_status_id != 4) { ?>btn-group<?php } ?>">
        ...
        <div class="options btn-group btn-group-sm">
            ...
            <ul class="dropdown-menu">
				...
				<li>
                    <a href="#" id="btn_generate_invoice"
                       data-invoice-id="<?php echo $invoice_id; ?>">
                        <i class="fa fa-print fa-margin"></i>
                        <?php echo "Download Packing List "; ?>
                    </a>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="panel panel-default no-margin">
                        <div class="panel-heading">Ship To *
                            <?php //_trans('invoice_terms'); ?>
                        </div>
                        <div class="panel-body">
                            <textarea id="invoice_terms" name="invoice_terms" class="form-control" rows="4" 
                                <?php if ($invoice->is_read_only == 1) {
                                    echo 'disabled="disabled"';
