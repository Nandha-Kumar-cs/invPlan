...
{
	if(($custom_field->custom_field_order)==99){ ?>
...
else
{
	...
	?>
		...
		<?php if(($custom_field->custom_field_label=='PO Number')||($custom_field->custom_field_label=='Currency')) {?>
        ...
        <div class="<?php echo $class_bottom; ?>">
            ...
            break;
            default:
            if($custom_field->custom_field_id==5){?>
            <input type="text" class="form-control"
                   name="custom[<?php echo $custom_field->custom_field_id; ?>]"
                   id="<?php echo $custom_field->custom_field_id; ?>"
                   value="<?php _htmlsc($fieldValue); ?>" required>
            <?php } else{ ?>
<input type="text" class="form-control"
                   name="custom[<?php echo $custom_field->custom_field_id; ?>]"
                   id="<?php echo $custom_field->custom_field_id; ?>"
