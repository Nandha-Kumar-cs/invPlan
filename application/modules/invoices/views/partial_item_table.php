...
<div class="row">
    ...
    <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4">
        <table class="table table-bordered text-right">
            ...
            <tr>
                <td style="width: 40%;"><?php _trans('item_tax'); ?></td>
                <td class="amount" style="width: 60%;"><?php echo format_currency($invoice->invoice_item_tax_total); ?></td>
            </tr>
            <tr>
                <td style="width: 40%; display:none;"><?php _trans('invoice_tax'); ?></td>
            ...
            <tr style="display:none;">
                <td class="td-vert-middle" style="width: 40%;"><?php _trans('discount'); ?></td>
                <td class="clearfix" style="width: 60%;">
            ...
            <tr>
                <td style="width: 30%;"><?php _trans('total'); ?></td>
			...
			if($invoice->invoice_paid!=0){
				?>
            <tr>
                <td style="width: 40%;"><?php _trans('paid'); ?></td>
                <td class="amount" style="width: 40%;"><b><?php echo format_currency($invoice->invoice_paid); ?></b></td>
            </tr>
			<?
			}
			else{
			...
			?>
            <tr>
                <td style="width: 40%;"><b><?php _trans('balance'); ?></b></td>
                <td class="amount" style="width: 40%;"><b><?php echo format_currency($invoice->invoice_balance); ?></b></td>
            </tr>
        </table>
    </div>
