            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="form-group" style="    width: 97%; margin: auto;  margin-top: 1%;">
                            <label for="client_adress"><?php _trans('Client Adress'); ?></label>

                            <div class="controls">
                                <textarea type="text" name="client_adress" id="client_adress" class="form-control"
                                       ><?php echo $this->mdl_clients->form_value('client_adress', true); ?></textarea>
                            </div>
                        </div>
