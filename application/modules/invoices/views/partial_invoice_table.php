                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('invoices/generate_pdf/' . $invoice->invoice_id); ?>"
                                   target="_blank">
                                    <i class="fa fa-print fa-margin"></i>  <?php echo "Download invoice "; ?>
                                </a>
                            </li>
							<li>
                                <a href="<?php echo site_url('invoices/generate_invoice/' . $invoice->invoice_id); ?>"
                                   target="_blank">
                                    <i class="fa fa-print fa-margin"></i> <?php echo "Download Packing List "; ?>
                                </a>
                            </li>
                            <li>
