...
$html  = '
    ...
    <body>
    <h3 style="margin-left:25%"><u>CERTIFICATE OF CONFORMANCE<u></h3> 
    <ul>
    ...
    <table margin-top:5%; style="border:2px;">
    <thead>
...
<tr style=" background-color:#B2B2B2;">
<th colspan="6" >Test Reports for Material for Rotor</th>
<th colspan="6" >Inspection.Report No.</th>
</tr>
</thead> 
<tbody>
<tr>
<td colspan="6" >'.$rotor.'</td>
<td colspan="6" >'.$reportno.' </td>
</tr>
</tbody>
</table>
