...
<body>
  ...
  <ul style="border: 2px solid;"height="40">
    ...
    <img src="/pdf1/images/magdyn4.jpg" alt="MagDyn" href="https://www.magdyn.com/" id="logo" width="200" height="27" style="margin-top:4px; margin-left:4px;">
 ...
 <ul style="border: 2px solid;"height="40">
    ...
    <table style="width:100%;margin-top:1%;">
        <tr>
            ...
            <td colspan="7"  style="text-align: center;" >Drawing No.: 544163101 R-006</td>
        </tr>
     ...
     <tr>
       <td colspan="14" style="font-size:11px;text-align: center;"><p ><u>Note: Dimensions are measured in mm,Converted values in Inches are recorded below. Where Special fixtures are used for conformance check OK or NOK is stated. Sampling Plan: 100%<u></p></td> </tr>';
     
       for ($x = 1; $x <= 16; $x++) {
     $html.='  <tr>
            <td>'.$x.'</td>
        <td style="width:8.3%;">'.$_POST['sno'.$x].'</td>
        <td style="width:8.3%;">OK</td>
        <td style="width:8.3%;">0,0016</td>
        <td style="width:8.3%;"><0.0018</td>
        <td style="width:8.3%;">OK</td>
        <td style="width:8.3%;">'.$_POST['rotor'.$x].'</td>
        <td style="width:8.3%;">'.$_POST['hubmin'.$x].'-'.$_POST['hubmax'.$x].'</td>
        <td style="width:8.3%;"><0.002</td>
        <td style="width:8.3%;">'.$_POST['od'.$x].'</td>
        <td style="width:8.3%;">< 0.002</td></tr>
   ...
   <td style="text-align:right;border: 2px solid white">Inspected By: RSK<br>Verified By: RSK</td>
   </tr>
    </table>
