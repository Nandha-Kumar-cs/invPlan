...
class Reports extends Admin_Controller
{
    ...
    public function invoice_aging_inr()
    {
        $this->layout->buffer('content', 'reports/invoice_aging_index_inr')->render();


    }
    public function inv_report()
    {
        $this->layout->buffer('content', 'reports/inv_report_index')->render();
