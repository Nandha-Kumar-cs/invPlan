...
<form  name="dutyForm"  action="<?= site_url('duties/create_duty') ?>" method="post" onsubmit="validateForm(event)">
<div>
    <h1>Create Duty slip</h1>
    <div class="flexable">
    ...
    <div class="flexable-width"  style="width:33%">
        ...
        <div>
        <input type="text" name="cust_name" id="cust_name" tabindex="2">
        </div>
    </div>
    ...
    <div  style="width:29%">
        ...
        <div >
        <input type="date" name="trip_date" id="trip_date" tabindex="3">
        </div>
    </div>
...
<div class="flexable">    
    ...
    <div  class="flexable-width">
        <label for="">Reporting Adress</label>
        <div>
        <input type="text" name="report_address" id="report_address" tabindex="4">
        </div>
    </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="text" name="booked_by" id="booked_by" tabindex="5">
        </div>
...
<div class="flexable">   
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="text" name="vehicle_no" id="vehicle_no" tabindex="6">
        </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="text" name="vehicle_type" id="vehicle_type" tabindex="7">
        </div>
...
<div class="flexable">    
    <div  class="flexable-width">
        ...
        <div>
        <input type="text" name="driver_name" id="driver_name" tabindex="8">
        </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="text" name="mobile_no" id="mobile_no" tabindex="9">
        </div>
...
<div class="flexable">        
    <div  class="flexable-width">
        ...
        <div>
        <input type="number" name="staring_km" id="staring_km"  oninput="startkm()" tabindex="10">
        </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="number" name="closing_km" id="closing_km"  oninput="closingkm()" tabindex="11">
        </div>
...
<div class="flexable">        
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="time" name="staring_time" id="staring_time"  oninput="startingtime()" tabindex="12">
        </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="time" name="closing_time" id="closing_time"  oninput="closingtime()" tabindex="13">
        </div>
...
<div class="flexable">    
    <div  class="flexable-width">
        ...
        <div>
        <input type="number" name="total_km" id="total_km" readonly class="disabled">
        </div>
    ...
    <div  class="flexable-width">
        ...
        <div>
        <input type="time" name="total_time" id="total_time" readonly class="disabled">
        </div>
    ...
    <div style="text-align: right;right: 51px; position: absolute;">
       <input type="submit" class="submit" tabindex="14" >
    </div>
